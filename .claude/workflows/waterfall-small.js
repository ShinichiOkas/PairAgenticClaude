export const meta = {
  ...
  description: "waterfall-small の成果物 DAG を 1 巡させる（役 5 ／ 機械 4 ／ 人間ゲート 1）",
  whenToUse: "成果物定義 waterfall-small.mk に沿って、要求から受入検査まで1 パス通したいとき。args.root に作業根を渡す",
  phases: [
    { title: "第1段", detail: "要求" },
    { title: "第2段", detail: "仕様" },
    { title: "第3段", detail: "受入検査仕様 / 実装物_v(n)" },
    { title: "第4段", detail: "実行可能物 / 設計保証 / 非回帰の合否" },
    { title: "第5段", detail: "受入検査報告書" },
    { title: "第6段", detail: "残留リスク報告" },
  ],
}

// 自動生成。手で編集しない。正は /Users/shinichi/work/PairAgenticClaude/models/waterfall-small.mk
// 生成: python tools/emit_claude.py /Users/shinichi/work/PairAgenticClaude/models/waterfall-small.mk
//
...
const NODES = {
  "要求": {
    ...
    "by": "machine",
    "agentType": "waterfall-small-normalize-request",
    "gate": "",
    "path": "upstream/要求.md",
    "deps": [
      {
  ...
  "仕様": {
    ...
    "by": "agent",
    "agentType": "waterfall-small-write-specification",
    "gate": "",
    "path": "upstream/仕様.md",
    "deps": [
      {
  ...
  "受入検査仕様": {
    ...
    "by": "agent",
    "agentType": "waterfall-small-design-acceptance-tests",
    "gate": "",
  ...
  "実装物": {
    ...
    "task": "build",
    "by": "agent",
    "agentType": "waterfall-small-build",
    "gate": "",
    "path": "実装物",
    "deps": [
      {
  ...
  "設計保証": {
    ...
    "task": "assure_design",
    "by": "agent",
    "agentType": "waterfall-small-assure-design",
    "gate": "",
  ...
  "実行可能物": {
    ...
    "task": "package",
    "by": "machine",
    "agentType": "waterfall-small-package",
    "gate": "",
    "path": "実行可能物",
    "deps": [
      {
  ...
  "受入検査報告書": {
    ...
    "by": "agent",
    "agentType": "waterfall-small-execute-acceptance-tests",
    "gate": "H3",
  ...
  "非回帰の合否": {
    ...
    "task": "run_regression",
    "by": "machine",
    "agentType": "waterfall-small-run-regression",
    "gate": "",
  ...
  "残留リスク報告": {
    ...
    "by": "machine",
    "agentType": "waterfall-small-aggregate-residual-risk",
    "gate": "",
...
const HUMAN = [
  {
    ...
    "post": [
      ...
      "受け手が読めない語彙を含まない",
      "**どのゲートで差し戻したかが書かれている**（H1/H2/H2b/H3 のどれか）（判定の根拠＝検査ケースの内容を含まない）"
    ],
    "out": [
