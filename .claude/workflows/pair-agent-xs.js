export const meta = {
  name: "pair-agent-xs",
  description: "pair-agent-xs の成果物 DAG を 1 巡させる（役 3 ／ 機械 1 ／ 人間ゲート 1）",
  whenToUse: "成果物定義 pair-agent-xs.mk に沿って、要求から受入検査まで1 パス通したいとき。args.root に作業根を渡す",
  phases: [
    { title: "第1段", detail: "受入検査仕様 / 実装物" },
    { title: "第2段", detail: "非回帰の合否" },
    { title: "第3段", detail: "受入検査報告書" },
  ],
}

// 自動生成。手で編集しない。正は /Users/shinichi/work/PairAgenticClaude/models/pair-agent-xs.mk
// 生成: python tools/emit_claude.py /Users/shinichi/work/PairAgenticClaude/models/pair-agent-xs.mk
//
...
const NODES = {
  "受入検査仕様": {
    ...
    "by": "agent",
    "agentType": "pair-agent-xs-design-acceptance-tests",
    "gate": "",
  ...
  "非回帰の合否": {
    ...
    "task": "run_regression",
    "by": "machine",
    "agentType": "pair-agent-xs-run-regression",
    "gate": "",
  ...
  "受入検査報告書": {
    ...
    "by": "agent",
    "agentType": "pair-agent-xs-execute-acceptance-tests",
    "gate": "H1",
