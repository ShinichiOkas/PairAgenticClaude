export const meta = {
  name: "pair-agent-m",
  description: "pair-agent-m の成果物 DAG を 1 巡させる（役 8 ／ 機械 1 ／ 人間ゲート 2）",
  whenToUse: "成果物定義 pair-agent-m.mk に沿って、要求から受入検査まで1 パス通したいとき。args.root に作業根を渡す",
  phases: [
    { title: "第1段", detail: "合意ドキュメント" },
    { title: "第2段", detail: "仕様" },
    { title: "第3段", detail: "受入検査仕様 / 実装物_v(n)" },
    { title: "第4段", detail: "設計保証 / 非回帰の合否" },
    { title: "第5段", detail: "受入検査報告書" },
    { title: "第6段", detail: "整合したドキュメント" },
    { title: "第7段", detail: "リポジトリの状態" },
  ],
}

// 自動生成。手で編集しない。正は /Users/shinichi/work/PairAgenticClaude/models/pair-agent-m.mk
// 生成: python tools/emit_claude.py /Users/shinichi/work/PairAgenticClaude/models/pair-agent-m.mk
//
...
const NODES = {
  "合意ドキュメント": {
    ...
    "task": "elicit_intent",
    "by": "agent",
    "agentType": "pair-agent-m-elicit-intent",
    "gate": "H1",
  ...
  "仕様": {
    ...
    "by": "agent",
    "agentType": "pair-agent-m-write-specification",
    "gate": "",
  ...
  "受入検査仕様": {
    ...
    "by": "agent",
    "agentType": "pair-agent-m-design-acceptance-tests",
    "gate": "",
  ...
  "非回帰の合否": {
    ...
    "task": "run_regression",
    "by": "machine",
    "agentType": "pair-agent-m-run-regression",
    "gate": "",
  ...
  "設計保証": {
    ...
    "task": "assure_design",
    "by": "agent",
    "agentType": "pair-agent-m-assure-design",
    "gate": "",
  ...
  "受入検査報告書": {
    ...
    "by": "agent",
    "agentType": "pair-agent-m-execute-acceptance-tests",
    "gate": "H2",
  ...
  "整合したドキュメント": {
    ...
    "by": "agent",
    "agentType": "pair-agent-m-reconcile-documents",
    "gate": "",
    "path": "docs/",
    "deps": [
      {
  ...
  "リポジトリの状態": {
    ...
    "by": "agent",
    "agentType": "pair-agent-m-sync-repository",
    "gate": "",
    "path": ".git",
    "deps": [
      {
