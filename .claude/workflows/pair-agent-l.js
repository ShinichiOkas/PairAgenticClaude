export const meta = {
  name: "pair-agent-l",
  description: "pair-agent-l の成果物 DAG を 1 巡させる（役 10 ／ 機械 2 ／ 人間ゲート 3）",
  whenToUse: "成果物定義 pair-agent-l.mk に沿って、要求から受入検査まで1 パス通したいとき。args.root に作業根を渡す",
  phases: [
    { title: "第1段", detail: "合意ドキュメント" },
    { title: "第2段", detail: "探針結果" },
    { title: "第3段", detail: "アーキテクチャ" },
    { title: "第4段", detail: "仕様" },
    { title: "第5段", detail: "受入検査仕様 / 実装物_v(n)" },
    { title: "第6段", detail: "設計保証 / 非回帰の合否" },
    { title: "第7段", detail: "受入検査報告書" },
    { title: "第8段", detail: "整合したドキュメント / 残留リスク報告" },
    { title: "第9段", detail: "リポジトリの状態" },
  ],
}

// 自動生成。手で編集しない。正は /Users/shinichi/work/PairAgenticClaude/models/pair-agent-l.mk
// 生成: python tools/emit_claude.py /Users/shinichi/work/PairAgenticClaude/models/pair-agent-l.mk
//
...
const NODES = {
  "合意ドキュメント": {
    ...
    "task": "elicit_intent",
    "by": "agent",
    "agentType": "pair-agent-l-elicit-intent",
    "gate": "H1",
    "path": ".pair-agent/agreements/合意ドキュメント.md",
    "deps": [
      {
        "name": "要望",
        "node": "要望",
        "kind": "必須",
        "path": ".pair-agent/inbox/要望.md"
      },
      {
        "name": "用語資産?",
        "node": "用語資産",
        "kind": "任意",
        "path": ".pair-agent/inbox/用語資産.md"
      }
    ],
    "blocks": [
      "実装物"
  ...
  "探針結果": {
    ...
    "task": "run_probe",
    "by": "agent",
    "agentType": "pair-agent-l-run-probe",
    "gate": "",
    "path": ".pair-agent/assurance/探針結果.md",
    "deps": [
      {
        "name": "合意ドキュメント",
        "node": "合意ドキュメント",
      ...
      },
      {
        ...
        "node": "既存システムの制約",
        "kind": "任意",
        "path": ".pair-agent/inbox/既存システムの制約.md"
      },
      {
        "name": "実行環境",
        "node": "実行環境",
  ...
  "アーキテクチャ": {
    ...
    "by": "agent",
    "agentType": "pair-agent-l-design-architecture",
    "gate": "",
    "path": ".pair-agent/agreements/アーキテクチャ.md",
    "deps": [
      {
        "name": "合意ドキュメント",
        "node": "合意ドキュメント",
  ...
  "仕様": {
    ...
    "by": "agent",
    "agentType": "pair-agent-l-write-specification",
    "gate": "H2",
    "path": ".pair-agent/agreements/仕様.md",
    "deps": [
      {
        "name": "アーキテクチャ",
        "node": "アーキテクチャ",
  ...
  "受入検査仕様": {
    ...
    "by": "agent",
    "agentType": "pair-agent-l-design-acceptance-tests",
    "gate": "",
  ...
  "非回帰の合否": {
    ...
    "task": "run_regression",
    "by": "machine",
    "agentType": "pair-agent-l-run-regression",
    "gate": "",
  ...
  "設計保証": {
    ...
    "task": "assure_design",
    "by": "agent",
    "agentType": "pair-agent-l-assure-design",
    "gate": "",
  ...
  "受入検査報告書": {
    ...
    "by": "agent",
    "agentType": "pair-agent-l-execute-acceptance-tests",
    "gate": "H3",
  ...
  "残留リスク報告": {
    ...
    "by": "machine",
    "agentType": "pair-agent-l-aggregate-residual-risk",
    "gate": "",
    "path": ".pair-agent/assurance/残留リスク報告.md",
    "deps": [
      {
        "name": "仕様",
        "node": "仕様",
  ...
  "整合したドキュメント": {
    ...
    "by": "agent",
    "agentType": "pair-agent-l-reconcile-documents",
    "gate": "",
    "path": "docs/",
    "deps": [
      {
      ...
      },
      {
        ...
        "node": "変更の履歴",
        "kind": "必須",
        "path": ".pair-agent/inbox/変更の履歴.md"
      }
    ],
    "blocks": [],
    "checks": [],
  ...
  "リポジトリの状態": {
    ...
    "by": "agent",
    "agentType": "pair-agent-l-sync-repository",
    "gate": "",
    "path": ".git",
    "deps": [
      {
