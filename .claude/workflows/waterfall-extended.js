export const meta = {
  name: "waterfall-extended",
  description: "waterfall-extended の成果物 DAG を 1 巡させる（役 7 ／ 機械 5 ／ 人間ゲート 4）",
  whenToUse: "成果物定義 waterfall-extended.mk に沿って、要求から受入検査まで1 パス通したいとき。args.root に作業根を渡す",
  phases: [
    { title: "第1段", detail: "要望" },
    { title: "第2段", detail: "用語定義" },
    { title: "第3段", detail: "要求" },
    { title: "第4段", detail: "仕様" },
    { title: "第5段", detail: "アーキテクチャ / 受入検査仕様" },
    { title: "第6段", detail: "設計書" },
    { title: "第7段", detail: "実装物_v(n)" },
    { title: "第8段", detail: "変異試験の合否 / 実行可能物 / 設計保証 / 非回帰の合否" },
    { title: "第9段", detail: "受入検査報告書" },
    { title: "第10段", detail: "残留リスク報告" },
  ],
}

// 自動生成。手で編集しない。正は /Users/shinichi/work/PairAgenticClaude/models/waterfall-extended.mk
// 生成: python tools/emit_claude.py /Users/shinichi/work/PairAgenticClaude/models/waterfall-extended.mk
//
...
const MODEL = "waterfall-extended"
const NODES = {
  "要望": {
    "target": "要望",
    "role": "機械",
    ...
    "by": "machine",
    "agentType": "waterfall-extended-capture-request",
    "gate": "",
    "path": "inbox/要望.md",
    "deps": [
      {
  ...
  "用語定義": {
    ...
    "by": "agent",
    "agentType": "waterfall-extended-elicit-definitions",
    "gate": "",
    "path": "upstream/用語定義.md",
    "deps": [
      {
        "name": "要望",
        "node": "要望",
  ...
  "要求": {
    ...
    "post": [
      "要望の項目が黙って落ちていない",
      "用語定義に無い曖昧な語が残っていない",
      "確定は人間の回答による。自分で定義を選んでいない",
      "**問いに依存関係が付いている**（上位に答えると下位が確定するか消える）"
    ],
    "out": [
      "何を達成したいか（用語定義で確定した語で書かれている）",
      "理由 ＋ 残留リスク"
    ],
    "skills": [
      "復唱・確認",
  ...
  "仕様": {
    ...
    "by": "agent",
    "agentType": "waterfall-extended-write-specification",
    "gate": "H2",
    "path": "upstream/仕様.md",
    "deps": [
      {
    ...
    "post": [
      ...
      "過剰なし —— 要求と用語定義から導出できないものを足していない（P-24）",
      "各項目が判定手続きに落とせる",
      "「不可能」と判定した項目は範囲外として上げている",
      "**暫定**として置いた項目には、**解除条件**（誰が何を答えたら差し替えるか）が付いている"
    ],
    "out": [
      "何を作るか。要求を 100% 説明する",
      "満たさない項目は理由と扱い（スコープ外／延期／代案／不可能／**暫定**）",
      "実装言語・対象プラットフォームの制約（P-30）",
      "理由 ＋ 残留リスク"
    ],
    "skills": [
      "判定可能な仕様の書き方",
  ...
  "アーキテクチャ": {
    ...
    "by": "agent",
    "agentType": "waterfall-extended-design-architecture",
    "gate": "H2b",
    "path": "upstream/アーキテクチャ.md",
    "deps": [
      {
        "name": "仕様",
        "node": "仕様",
    ...
    "post": [
      "仕様の各品質要求に対応する構造上の手当てがある",
      "制約が「守られたか」を後から検査できる形で書かれている",
      "仕様に無い機能を構造として先取りしていない"
    ],
    "out": [
  ...
  "設計書": {
    ...
    "by": "agent",
    "agentType": "waterfall-extended-write-detailed-design",
    "gate": "",
    "path": "upstream/設計書.md",
    "deps": [
      {
        "name": "アーキテクチャ",
        "node": "アーキテクチャ",
    ...
    "post": [
      "アーキテクチャの構造制約に違反していない",
      "仕様の各項目が、どの構成要素で満たされるか対応が付いている"
    ],
    "out": [
      "実装の内部の申し合わせ（インタフェース・データ構造・分担の境界）",
      "理由 ＋ 残留リスク"
    ],
    "skills": [
      "インタフェース設計",
  ...
  "受入検査仕様": {
    ...
    "by": "agent",
    "agentType": "waterfall-extended-design-acceptance-tests",
    "gate": "",
  ...
  "設計保証": {
    ...
    "task": "assure_design",
    "by": "agent",
    "agentType": "waterfall-extended-assure-design",
    "gate": "",
  ...
  "実行可能物": {
    ...
    "task": "package",
    "by": "machine",
    "agentType": "waterfall-extended-package",
    "gate": "",
    "path": "実行可能物",
    "deps": [
      {
  ...
  "受入検査報告書": {
    ...
    "by": "agent",
    "agentType": "waterfall-extended-execute-acceptance-tests",
    "gate": "H3",
    ...
    "post": [
      ...
      "合否が二値である",
      "カバーできなかった領域が明示されている",
      "欠陥を見つけても直していない —— 修正は 実装物 の再作成に回す",
  ...
  "変異試験の合否": {
    ...
    "by": "machine",
    "agentType": "waterfall-extended-run-mutation-testing",
    "gate": "",
  ...
  "非回帰の合否": {
    ...
    "task": "run_regression",
    "by": "machine",
    "agentType": "waterfall-extended-run-regression",
    "gate": "",
  ...
  "残留リスク報告": {
    ...
    "by": "machine",
    "agentType": "waterfall-extended-aggregate-residual-risk",
    "gate": "",
...
const HUMAN = [
  {
    ...
    "out": [
      "差し戻し先（暫定。一意に決まらない・G-35）",
      "なぜ差し戻されるか —— 受け手の deps の語彙で",
      "同一項目の再発回数"
    ]
  }
]
